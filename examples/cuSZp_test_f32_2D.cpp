...
int main()
{
    ...
    for(int i=0; i<3; i++)
    {
        ...
        cuSZp_decompress(d_decData, d_cmpBytes, nbEle, cmpSize1, errorBound, CUSZP_DIM_2D, dims, CUSZP_TYPE_FLOAT, CUSZP_MODE_FIXED, stream);
        cudaMemset(d_cmpBytes, 0, sizeof(float)*nbEle);
    }

    // cuSZp-f testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-f-2D-f32 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_2D_fixed_f32(d_decData, d_cmpBytes, nbEle, cmpSize1, dims, errorBound, stream);
    ...
    // cuSZp-p testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-p-2D-f32 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_compress_2D_plain_f32(d_oriData, d_cmpBytes, nbEle, &cmpSize2, dims, errorBound, stream);
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_2D_plain_f32(d_decData, d_cmpBytes, nbEle, cmpSize2, dims, errorBound, stream);
    ...
    // cuSZp-o testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-o-2D-f32 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_compress_2D_outlier_f32(d_oriData, d_cmpBytes, nbEle, &cmpSize3, dims, errorBound, stream);
    cmpTime = timer_GPU.GetCounter();
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_2D_outlier_f32(d_decData, d_cmpBytes, nbEle, cmpSize3, dims, errorBound, stream);
    decTime = timer_GPU.GetCounter();
