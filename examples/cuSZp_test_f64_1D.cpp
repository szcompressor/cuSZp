...
int main()
{
    ...
    for(int i=0; i<3; i++)
    {
        ...
        cuSZp_decompress(d_decData, d_cmpBytes, nbEle, cmpSize1, errorBound, CUSZP_DIM_1D, {0, 0, 0}, CUSZP_TYPE_DOUBLE, CUSZP_MODE_FIXED, stream);
        cudaMemset(d_cmpBytes, 0, sizeof(double)*nbEle);
    }

    // cuSZp-f testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-f-1D-f64 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_1D_fixed_f64(d_decData, d_cmpBytes, nbEle, cmpSize1, errorBound, stream);
    ...
    // cuSZp-p testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-p-1D-f64 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_compress_1D_plain_f64(d_oriData, d_cmpBytes, nbEle, &cmpSize2, errorBound, stream);
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_1D_plain_f64(d_decData, d_cmpBytes, nbEle, cmpSize2, errorBound, stream);
    ...
    // cuSZp-o testing.
    printf("=================================================\n");
    printf("========Testing cuSZp-o-1D-f64 on REL 1E-2=======\n");
    printf("=================================================\n");
    // cuSZp compression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_compress_1D_outlier_f64(d_oriData, d_cmpBytes, nbEle, &cmpSize3, errorBound, stream);
    cmpTime = timer_GPU.GetCounter();
    ...
    // cuSZp decompression.
    timer_GPU.StartCounter(); // set timer
    cuSZp_decompress_1D_outlier_f64(d_decData, d_cmpBytes, nbEle, cmpSize3, errorBound, stream);
    decTime = timer_GPU.GetCounter();
